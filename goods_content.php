<div class="card mb-3">
    <div class="row g-0">
        <div class="col-md-4">
            ...
            ?>
            <img src="./images/<?php echo $imgList['img_file']; ?>" id="showGoods" name="showGoods" class="img-fluid rounded-start" alt="<?php echo $data['p_name']; ?>" width="600px" height="550px">
            <div class="row mt-2">
                <?php do { ?>
                    <div class="col-md-4"><a href="./images/<?php echo $imgList['img_file']; ?>" rel="group" class="fancybox"><img src="./images/<?php echo $imgList['img_file']; ?>" alt="<?php echo $data['p_name']; ?>" class="img-fluid"></a>
                    </div>
